...
* **Pagamento Autônomo Integrado:** O sistema fornece uma interface para que o próprio usuário processe o pagamento da sua estadia através de múltiplas modalidades (Pix, Cartão de Crédito, Cartão de Débito e TAG).
...
* **Confiabilidade** e **Recuperação**: O sistema na recepção/cancela possui a capacidade de operar temporariamente offline e sincronizar os dados posteriormente com o servidor principal, com rotinas robustas de validação em caso de queda de rede.
* **Segurança de Rede**: Toda a comunicação do sistema com o banco de dados e a internet passa obrigatoriamente por um Firewall físico.
